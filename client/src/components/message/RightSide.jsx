...
const RightSide = () => {
  ...
  const handleChangeMedia = (e) => {
    ...
    files.forEach((file) => {
      ...
      if (file.size > 1024 * 1024 * 5) {
        return (err = 'The image/video largest size is 5mb.');
      }
  ...
  const caller = ({ video }) => {
    ...
    dispatch({ type: TYPES.CALL, payload: msg });
  };
    ...
    <>
      ...
      <form className="chat_input" onSubmit={handleSubmit}>
        ...
        <div className="file_upload">
          <i className="text-danger fas fa-image" />
          <input
            type="file"
            name="file"
            id="file"
        ...
        <button
          ...
          disabled={text.length !== 0 || media.length !== 0 ? false : true}
        >
          near_me
        </button>
      </form>
